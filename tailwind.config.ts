...
const config: Config = {
  ...
  content: [
	...
	theme: {
        ...
        muted: {
          DEFAULT: "hsl(210, 40%, 96.1%)", // gray-100
          foreground: "hsl(215, 16%, 47%)", // gray-500
        },
        accent: {
          DEFAULT: "hsl(210, 40%, 96.1%)", // gray-100
	...
	plugins: [require("tailwindcss-animate"), require('tailwind-scrollbar'), addVariablesForColors, function ({ matchUtilities, theme }: any) {
		matchUtilities(
			{
				"bg-grid": (value: any) => ({
