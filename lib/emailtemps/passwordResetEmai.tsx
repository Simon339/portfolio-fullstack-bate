...
interface PasswordrestemailtokenProps {
    resetLink: string
}

export const PasswordResetEmail: React.FC<PasswordrestemailtokenProps> = ({ resetLink }) => {
    return (
        <html lang="en">
        <head>
          <meta charSet="UTF-8" />
              ...
              <tr>
                <td style={{ padding: "20px" }}>
                  ...
                  <p style={{ textAlign: "center", margin: "30px 0" }}>
                    <a href={`${resetLink}`} style={{ backgroundColor: "#000319", color: "white", padding: "12px 24px", textDecoration: "none", display: "inline-block", borderRadius: "4px", fontWeight: "bold" }}>Reset now</a>
                  </p>
                  <p><strong>Please note:</strong>This reset link will expire within 24 hours for security reasons.</p>
                  <br></br>
                  <p>If you need further assistance, please feel free to contact our support team.</p>
                  <br></br>
                   <p>Sincerely,
                    <br />
                    Support Team
