        ...
        >
          ...
          <div style={{ padding: "40px 30px", backgroundColor: "#ffffff" }}>
            ...
            <p style={{ fontSize: "16px", marginBottom: "25px" }}>
              We've added your account to the portal. To get started, here is your temporary password:
            </p>
            ...
            <p style={{ fontSize: "16px", marginBottom: "25px" }}>
              Please click the button below to verify your account and set up your permanent password:
            </p>
            ...
            <p style={{ fontSize: "16px", marginBottom: "25px" }}>
              Once you've set your password, you'll be able to log in and access your account. If you didn't request
              this, please contact our Support Team immediately.
            </p>
            ...
            >
              <p style={{ margin: "0 0 10px 0" }}>Welcome aboard,</p>
