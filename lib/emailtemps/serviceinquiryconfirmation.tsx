...
export const ServiceInquiryConfirmationTemp: React.FC<ServiceInquiryConfirmationTempProps> = ({
  name,
  email,
  companyName,
  phoneNumber,
        ...
        >
          ...
          <div style={{ padding: "40px 30px", backgroundColor: "#ffffff" }}>
            ...
            <p style={{ fontSize: "16px", marginBottom: "25px" }}>
              Thank you for reaching out to us regarding our services. We have received your request and will respond
              within <span style={{ fontWeight: "bold" }}>3-7 business days</span> via email or phone call.
            </p>
            ...
            >
              <p style={{ fontSize: "16px", fontWeight: 600, marginTop: 0, marginBottom: "15px" }}>Request Details:</p>
              ...
              <table style={{ width: "100%", borderCollapse: "collapse" }}>
                <tbody>
                  ...
                  <tr>
                    <td style={{ padding: "8px 0", fontSize: "15px", color: "#666" }}>Company:</td>
                    <td style={{ padding: "8px 0", fontSize: "15px", fontWeight: 500 }}>{companyName}</td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <td style={{ padding: "8px 0", fontSize: "15px", color: "#666" }}>Phone:</td>
                    <td style={{ padding: "8px 0", fontSize: "15px", fontWeight: 500 }}>{phoneNumber}</td>
                  </tr>
                  <tr>
                    <td style={{ padding: "8px 0", fontSize: "15px", color: "#666" }}>Service:</td>
                    <td style={{ padding: "8px 0", fontSize: "15px", fontWeight: 500 }}>{service}</td>
                  </tr>
                </tbody>
              </table>
            </div>
            ...
            <p style={{ fontSize: "16px", marginBottom: "25px" }}>
              If you need to update any information or have any questions in the meantime, please do not hesitate to
              contact us.
            </p>
