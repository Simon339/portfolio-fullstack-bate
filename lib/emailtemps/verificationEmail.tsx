            ...
            <tbody>
              ...
              <tr>
                <td style={{ padding: "20px" }}>
                  ...
                  <br></br>
                  <p>
                  Thank you for signing up with us. To complete your registration and start using our services, please verify your email address by clicking the link below:</p>
                  <br></br>
                  ...
                  <br></br>
                  <p>If you did not create an account with us, please ignore this email. If you need assistance, feel free to contact our support team.</p>
                  <br></br>
