...
import { getCurrentUser, signOut } from '@/lib/auth/login';
            ...
            <SidebarContent className='mt-2'>
              <div className="flex flex-col items-center py-4">
                <Avatar className="w-24 text-white h-24 mb-2">
                  <AvatarImage src={`https://api.dicebear.com/6.x/initials/svg?seed=admin`} alt="profile" />
                  <AvatarFallback>
                    {/* \ */}
                  </AvatarFallback>
                </Avatar>
          ...
          <div className="flex flex-col flex-1 overflow-hidden">
            <header className="flex h-11 items-center backdrop-blur-md text-gray-800 font-semibold border-none justify-between p-4 border-b">
              ...
              <div className="flex items-center space-x-4">
                ...
                <span className="text-sm font-medium mt-2">Welcome, Admin!</span>
              </div>
            </header>
