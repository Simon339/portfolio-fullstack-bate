    ...
    <SidebarProvider className="min-h-screen bg-white">
      <div className="flex grow min-h-screen  bg-gray-200 overflow-hidden">
        ...
        <div className="flex flex-col flex-1 overflow-hidden">
            ...
            <div className="flex items-center">
              ...
              <div className="relative hidden sm:block">
                ...
                <Input
                  type="search"
                  placeholder="Search..."
                  className="pl-8 h-8 w-64 bg-gray-50 border-[#acc2ef] text-sm"
                />
              </div>
            </div>
            <div className="flex items-center space-x-3">
              <Badge badgeContent={unreadNotificationsCount} color="primary" className="mt-1">
                <Dropdown>
                  <DropdownTrigger>
                    ...
                    <DropdownSection title="Notifications">
                      {unreadNotifications.length > 0 ? (
                        unreadNotifications.map((notification) => (
                          <DropdownItem key={notification.id} className="w-72">
                            <NotificationNavCard {...notification} onRead={() => handleMarkAsRead(notification)} />
                          </DropdownItem>
                        ))
                      ) : (
                        <DropdownItem key={""}>
          ...
          <main className="grow overflow-y-auto  bg-gray-200 p-4">
            {children}
