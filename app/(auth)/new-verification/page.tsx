...
const Header: React.FC = () => (
    <header className="p-6 bg-white rounded-t-xl">
        <h1 className="text-3xl font-bold text-center text-gray-800 mb-2">Verification Email Assistance</h1>
        <p className="text-center text-gray-600 mb-6">Didn&apos;t receive your verification email or lost it? Request a new one below.</p>
    </header>
)
