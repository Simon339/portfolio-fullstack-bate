                ...
                <CardContent className="p-2">
                    ...
                    <Form {...form}>
                        ...
                        >
                            ...
                            <Button disabled={isPending}   className="w-full bg-[#000B58] border-[#0179FE] font-semibold  rounded-md py-2 text-white transition duration-200 ease-in-out hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2" type="submit">
                            {isPending ? (
                                    <>
