                ...
                >
                  <div className="flex flex-col sm:flex-row gap-2.5 sm:gap-3">
                    ...
                    <Button
                      ...
                      className={`flex-1 h-11 border-slate-200 hover:border-blue-400 hover:bg-blue-50/50 transition-all duration-200 rounded-xl font-medium text-slate-700 hover:text-slate-900 shadow-sm disabled:opacity-50 disabled:cursor-not-allowed focus:outline-none focus:ring-2 focus:ring-blue-500/30 focus:ring-offset-2 ${lastMethod === "google" ? "border-blue-300 bg-blue-50/30" : ""
                        }`}
                    >
                      {isLoading === "google" ? (
                    ...
                    <Button
                      ...
                      className={`flex-1 h-11 border-slate-200 hover:border-slate-400 hover:bg-slate-50 transition-all duration-200 rounded-xl font-medium text-slate-700 hover:text-slate-900 shadow-sm disabled:opacity-50 disabled:cursor-not-allowed focus:outline-none focus:ring-2 focus:ring-slate-500/30 focus:ring-offset-2 ${lastMethod === "github" ? "border-slate-400 bg-slate-50" : ""
                        }`}
                    >
                      {isLoading === "github" ? (
                        <Loader2 className="w-4 h-4 animate-spin" />
