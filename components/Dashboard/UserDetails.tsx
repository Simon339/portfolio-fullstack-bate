        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <div className="flex items-center gap-2 mt-1">
              <Chip
                variant="flat"
                color={getRoleColor(currentUser.role as "USER" | "SUPER_ADMIN" | "ADMIN")}
                className="px-2 py-0 text-xs font-normal border-[#acc2ef] text-gray-800"
              >
      ...
      <div className="p-6">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          ...
          <div className="space-y-2">
            ...
            <Select onValueChange={handleApprovalChange} value={currentUser.approvalStatus} disabled={isUpdatingStatus}>
              <SelectTrigger className="bg-white border-[#acc2ef]">
        ...
        <div className="mt-8">
          ...
          <ScrollArea className="h-[300px] w-full rounded-md border border-[#acc2ef] p-4">
