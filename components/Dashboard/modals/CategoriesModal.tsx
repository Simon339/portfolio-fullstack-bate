...
const CategoriesModal = () => {
    ...
    const onSubmit = async (data: z.infer<typeof CategoriesSchema>) => {
        ...
        try {
            ...
            toast.success('Catergory Created successfully!', {
                duration: 3000,
            });
            ...
            toast.error('Failed to create Catergory', {
                duration: 3000,
            })
        } finally {
    ...
    return (
        <Dialog open={isOpen} onOpenChange={setIsOpen}>
            ...
            <DialogContent className="sm:max-w-[458px] bg-[#0F1C2E] text-[#acc2ef]">
                <DialogHeader>
                    <DialogTitle className="flex flex-col gap-1 justify-center items-center align-middle text-lg font-bold">Create New Category
                    </DialogTitle>
                </DialogHeader>
                <Form {...form}>
